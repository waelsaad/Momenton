...
open class AccordionTableViewController: UITableViewController {
    ...
    @objc open var total = 0
    
    /// The identifier for the parent cells.
    @objc let parentCellIdentifier = "ParentCell"
    
    /// The identifier for the child cells.
    @objc let childCellIdentifier = "ChildCell"
     ...
     */
    @objc open func expandItemAtIndex(_ index : Int, parent: Int) {
     ...
     */
    @objc open func collapseSubItemsAtIndex(_ index : Int, parent: Int) {
     ...
     */
    @objc open func updateCells(_ parent: Int, index: Int) {
